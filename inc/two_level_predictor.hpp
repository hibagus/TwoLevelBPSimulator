...
{
public:
    static bool isParameterValid(unsigned int i, unsigned int j, unsigned int k, unsigned int s);
	static std::string getParameterErrorInfo(unsigned int i, unsigned int j, unsigned int k, unsigned int s);
	static std::string getPredictorTypeString(unsigned int i, unsigned int j, unsigned int k, unsigned int s);
